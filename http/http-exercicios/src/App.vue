<template>
  <div id="app" class="container">
    ...
    <b-card>
      ...
      <b-button class="ml-2" @click="obterUsuarios" size="lg" variant="success">Obter usuarios</b-button>
    </b-card>
  ...
  methods: {
    ...
    obterUsuarios() {
      this.$http
        ...
        .catch(_ => {
          this.mensagens.push({
            texto: "problema para Obter usuários",
            tipo: "danger"
          });
        });
    }
